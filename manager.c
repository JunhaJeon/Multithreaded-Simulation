...
void manager_clean(Manager *manager) {
    system_array_clean(&manager->system_array); // Cleans up all systems
    resource_array_clean(&manager->resource_array); // Cleans up all resources
    event_queue_clean(&manager->event_queue); // Cleans event queue
